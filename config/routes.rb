Rails.application.routes.draw do
  ...
  get '/cards/:id/update' => 'cards#update'

  # DELETE
  get '/cards/:id/destroy' => 'cards#destroy'
  #------------------------------

  # Routes for the Deck resource:
  # CREATE
  get '/new_deck' => 'decks#new'
  get '/create_deck' => 'decks#create'
  ...
  get '/decks/:id/update' => 'decks#update'
